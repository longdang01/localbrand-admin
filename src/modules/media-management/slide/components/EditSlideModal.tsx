...
const EditSlideModal = ({ id }: Props) => {
    ...
    const currentSlide = useGetByIdSlide({
        id,
        config: {
            onSuccess: (response) => {
                form.setFieldsValue({
        ...
        config: {
            onSuccess: (_) => {
                ...
                notification.success({
                    message: t('slide.update_success'),
                });
        ...
        setFileList([
            {
                ...
                name: DEFAULT_NAME_FILE_LIST,
                status: DEFAULT_STATUS_FILE_LIST,
                url: currentSlide?.data?.picture || noImage,
            },
        ]);
        form.setFieldValue('picture', currentSlide?.data?.picture);
    };
    ...
    const handleSubmit = () => {
        form.validateFields()
            .then(async (values) => {
                values.picture =
                    values?.picture || currentSlide?.data?.picture;
    ...
    return (
        <>
            <ModalRender
                ...
                confirmLoading={loadingAvatar || updateSlide?.isLoading}
            >
