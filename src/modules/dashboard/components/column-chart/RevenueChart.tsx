import { useGetTotalRevenue } from '@/loaders/statistics.loader';
...
const RevenueChart = () => {
    ...
    const getRevenueChart = useGetTotalRevenue({});

    const config: any = {
        data: getRevenueChart?.data
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <BarChartOutlined />
                    {t('column_chart.revenue')}
                </Typography.Text>

                {getRevenueChart?.isLoading ? (
